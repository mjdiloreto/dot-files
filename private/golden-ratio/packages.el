;;; packages.el --- golden-ratio layer packages file for Spacemacs.
;;
;; Copyright (c) 2012-2018 Sylvain Benner & Contributors
;;
;; Author: Matthew DiLoreto <mjdiloreto@gmail.com>
...
;; added to `golden-ratio-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `golden-ratio/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `golden-ratio/pre-init-PACKAGE' and/or
;;   `golden-ratio/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst golden-ratio-packages
  '()
  "The list of Lisp packages required by the golden-ratio layer.
...
(defun golden-ratio/init-golden-ratio ()
