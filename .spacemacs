...
you should place your code here."
  (setq org-publish-project-alist
        '(("orgfiles"
           :base-directory "~/Documents/publish/orgfiles/"
           :publishing-directory "~/public_html/orgfiles/"
          ...
          ("images"
           :base-directory "~/Documents/publish/img/"
           :base-extension "jpg\\|gif\\|png"
           :publishing-directory "~/public_html/img/"
           :publishing-function org-publish-attachment)

          ("other"
           :base-directory "~/Documents/publish/other/"
    ...
    (with-eval-after-load 'org-capture
        ...
        (let* (;; http://www.holgerschurig.de/en/emacs-blog-from-org-to-hugo/
          ...
          (mapconcat #'identity
                     `(
                       ...
                       "#+HUGO_SECTION: posts"
                       ,(concat "#+DATE: " date) ;Enter current date and time
                       ,(concat "#+TITLE: " title)
      ...
      (defun capture-report-data-file ()
        (let ((name (read-string "Filename: ")))
          (expand-file-name (format "~/Documents/publish/orgfiles/needs_work/%s.org" name))))

      (add-to-list 'org-capture-templates
                   '("h"                ;`org-capture' binding + h
                     "Hugo post"
                     plain  ; plain text inserted as-is. As opposed to entry
